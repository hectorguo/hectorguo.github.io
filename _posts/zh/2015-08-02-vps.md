...
因此选了 [DigtalOcean](https://www.digitalocean.com/?refcode=a3a117e9a9fe)，之所以选它而不是[linode](https://www.linode.com/)，是因为一注册就会送10刀，每月最低5刀，而且如果是学生，还有[教育优惠](https://education.github.com/pack)，额外赠送100刀！这样下来，很划算了。
...
接着新建一个json配置文件，用来初始化shadowsocks，并且支持多用户（即多个端口）。
...
附上常用的几种平台的客户端下载链接：
[Mac OS](http://sourceforge.net/projects/shadowsocksgui/files/dist/ShadowsocksX-2.6.3.dmg)  [Windows](http://sourceforge.net/projects/shadowsocksgui/files/dist/Shadowsocks-win-dotnet4.0-2.3.1.zip)
